...
const uiPerustiedot: Perustiedot = {
    alkuPvm: '2000-10-10',
    kielet: [],
    kotipaikka: { label: 'Helsinki', value: 'kunta_1#1', arvo: 'kunta_1' },
    maa: { label: 'Suomi', value: 'maa_1#1', arvo: 'maa_1' },
    muutKotipaikat: [],
    nimi: { fi: 'uusinimi' },
    organisaatioTyypit: [],
    oppilaitosTyyppiUri: { label: 'Peruskoulut', value: 'oppilaitostyyppi_11#1', arvo: 'oppilaitostyyppi_1' },
    oppilaitosKoodi: '',
    muutOppilaitosTyyppiUris: [],
    vuosiluokat: [],
};
