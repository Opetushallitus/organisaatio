        ...
        <div className={styles.UloinKehys}>
                ...
                <div className={styles.Rivi}>
                    ...
                    <div className={styles.Kentta}>
                        ...
                        <Select
                            isMulti
                            value={organisaatio.muutKotipaikatUris.length ? organisaatio.muutKotipaikatUris.map((mk: string) => kaikkiKunnat.find(kk => kk.value === mk)) : []}
                            options={kaikkiKunnat}
                            onChange={(option= []) => {
                                handleOnChange({ name: 'muutKotipaikatUris', value: option ? (option as iOption[]).map(o => o.value): []})
                            }}
                ...
                <div className={styles.Rivi}>
                    <div className={styles.Kentta}>
                        ...
                        <Select
                            onChange={(selected= []) => handleOnChange({ name: 'kieletUris', value: selected ? (selected as iOption[]).map(o => o.value) : []})}
                            isMulti
                            value={organisaatio.muutKotipaikatUris && organisaatio.kieletUris.map((ku: string) => kielistetytOpetuskielet.find((ok : any) => ku === ok.value))}
