...
public interface OrganisaatioResourceV3 {
    ...
    List<OrganisaatioRDTOV3> findByOids(@ApiParam(value = "JSON-taulukko organisaatio OIDeja: [\"oid1\", \"oid2\", ...]",
    ...
    @ApiOperation(
            ...
            response = ResultRDTOV3.class)
    ResultRDTOV3 newOrganisaatio(@ApiParam(access = "hidden") OrganisaatioRDTOV3 ordto);
    ...
    @ApiOperation(
            ...
            response = OrganisaatioRDTOV3.class,
            responseContainer = "List")
    List<OrganisaatioRDTOV3> haeMuutetut(@ApiParam(value = "Muokattu jälkeen", required = true) @RequestParam DateParam lastModifiedSince,
                                         @ApiParam(value = "Palaulautetaanko vastauksen mukana mahdollinen organisaation kuva (voi olla iso).",
                                                 defaultValue = "false") @RequestParam(defaultValue = "false") boolean includeImage);
