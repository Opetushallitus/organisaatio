...
update "schema_version_history" set checksum=-1593237099 where version='005';
update "schema_version_history" set checksum=-1004438007 where version='006';
...
update "schema_version_history" set checksum=-521217950 where version='009';
...
update "schema_version_history" set checksum=451849785 where version='012';
update "schema_version_history" set checksum=826248184 where version='013';
update "schema_version_history" set checksum=-232460788 where version='014';
...
update "schema_version_history" set checksum=1557422461 where version='021';
...
update "schema_version_history" set checksum=1194359728 where version='043';
...
update "schema_version_history" set checksum=-564017891 where version='046';
update "schema_version_history" set checksum=1036774769 where version='047';
update "schema_version_history" set checksum=1678956109 where version='048';
...
update "schema_version_history" set checksum=1428884896 where version='075';
...
update "schema_version_history" set checksum=-516033922 where version='202011061140510';
...
update "schema_version_history" set checksum=-964125814 where version='20190919114201262';
...
update "schema_version_history" set checksum=-62409156 where version='20201117125129000';
update "schema_version_history" set checksum=1748871511 where version='20201124160000000';
update "schema_version_history" set checksum=-1641308311 where version='20210112120000000';
update "schema_version_history" set checksum=1297541332 where version='20210113120000000';
update "schema_version_history" set checksum=-1002781473 where version='20210127120000000';
