...
-- insert into / select, jotta insert ei hajoa mikäli child tai parent ei ole olemassa
insert into organisaatiosuhde (id, version, alkupvm, suhdetyyppi, child_id, parent_id, paivityspvm, paivittaja)
 select nextval('public.hibernate_sequence'), 0, timestamp '2014-08-01 00:00:00.000', 'HISTORIA', child_id, parent_id, current_date, 'oph' from organisaatiosuhde where child_id = 12570 and parent_id = 3226;
