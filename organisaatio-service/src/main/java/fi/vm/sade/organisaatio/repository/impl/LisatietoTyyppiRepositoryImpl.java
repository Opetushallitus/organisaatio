...
@Repository
public class LisatietoTyyppiRepositoryImpl implements LisatietoTyyppiRepositoryCustom {
    ...
    public Set<String> findValidByOrganisaatiotyyppiAndOppilaitostyyppi(String organisaatioOid) {
        ...
        List<String> lisatietotyyppiNimiList = new JPAQuery<>(em)
    ...
    public Optional<Lisatietotyyppi> findByNimi(String nimi) {
        ...
        Lisatietotyyppi lisatietotyyppiResult = new JPAQuery<Lisatietotyyppi>(em)
