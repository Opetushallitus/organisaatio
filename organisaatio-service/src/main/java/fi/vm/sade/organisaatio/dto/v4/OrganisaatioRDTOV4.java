...
public class OrganisaatioRDTOV4 implements Serializable {
    ...
    @Schema(description = "Organisaation muiden kotipaikkojen URIt", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Tyypit koodiarvoina. Kts. organisaatiotyypit koodisto", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Lisatiedot", requiredMode = Schema.RequiredMode.REQUIRED)
