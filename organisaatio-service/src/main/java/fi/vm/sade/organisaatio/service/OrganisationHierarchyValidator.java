 ...
 * 
 * <li>Jos organisaatio on OPPILAITOS, sillä on oltava yläorganisaatio tyypiltään KOULUTUSTOIMIJA.
 * <li>Jos organisaatio on MUU ORGANISAATIO tai KOULUTUSTOMIJA ja sille on määritelty yläorganisaatio,
 * 		on yläorganisaation oltava joko OPH tai MUU ORGANISAATIO.
 * <li>Jos organisaatio on OPETUSPISTE (eli toimipiste), sillä on oltava yläorganisaatio joka on tyypiltään joko
...
public class OrganisationHierarchyValidator implements Predicate<Entry<Organisaatio, Organisaatio>> {
	...
	public boolean apply(Entry<Organisaatio, Organisaatio> parentChild) {
        ...
        return Predicates.or(oppilaitosRule, muuOrgRule, toimipisteRule, koulutustoimijaRule).apply(parentChild);
    }
