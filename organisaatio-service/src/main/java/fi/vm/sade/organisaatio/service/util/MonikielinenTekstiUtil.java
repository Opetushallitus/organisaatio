...
public class MonikielinenTekstiUtil {
    ...
    // Returns true if the two MonikielinenTekstis have same koodiValue in any kieliKoodi.
    ...
    // Returns true if the two MonikielinenTekstis have same koodiValue in any kieliKoodi (except if ignoreEmptyValues is true and the same values are empty strings).
