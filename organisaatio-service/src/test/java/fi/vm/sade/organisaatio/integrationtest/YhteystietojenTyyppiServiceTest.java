...
public class YhteystietojenTyyppiServiceTest extends SecurityAwareTestBase {
    ...
    public void roundtrip_metadata() throws GenericFault {//ValidationException, OrganisaatioHierarchyException {
        ...
        dto.getSovellettavatOrganisaatios().add(OrganisaatioTyyppi.MUU_ORGANISAATIO);
        dto.getSovellettavatOrganisaatios().add(OrganisaatioTyyppi.TOIMIPISTE);
    ...
    private void change(YhteystietojenTyyppiDTO dto) {
        ...
        // poistetaan toimipiste litietyistä organisaatiotyypeistä
        dto.getSovellettavatOrganisaatios().remove(OrganisaatioTyyppi.TOIMIPISTE);
    }
    ...
    public void roundtrip_arvot() throws GenericFault {
        ...
        // luodaan uusi organisaatio tyyppiä toimipiste, jolle asetetaan lisätietokenttien arvot
    ...
    private YhteystietoArvoDTO createYTA(String orgOid, String yttElOid, Object arvo) {
        return createYTA(orgOid, yttElOid, arvo, "kieli_fi#1");
    }

    private YhteystietoArvoDTO createYTA(String orgOid, String yttElOid, Object arvo, String lang) {
    ...
    public void saveLisatietokenttaArvo_kenttaPlusOrganisaatioIsUnique() throws GenericFault {
        ...
        // kieliversiot
        model = buildCreateOrganisaatioModel(organisaatioService, buildYtunnus(), parent.getOid(), OrganisaatioTyyppi.OPPILAITOS.value());
        model.getYhteystietoArvos().add(createYTA(null, getLisatietokentta(lisatiedot, YhteystietoElementtiTyyppi.TEKSTI,  "nimi").getOid(), "foobar", "kieli_fi#1"));
        model.getYhteystietoArvos().add(createYTA(null, getLisatietokentta(lisatiedot, YhteystietoElementtiTyyppi.TEKSTI,  "nimi").getOid(), "foobar2", "kieli_sv#1"));
        organisaatioService.createOrganisaatio(model, false);
...
//            SQLException nextException = sqlException.getNextException();
    ...
    public void saveLisatietokenttaArvo_nullArvoInNotPakollinenKentta() throws GenericFault {
        ...
        model = buildCreateOrganisaatioModel(organisaatioService, buildYtunnus(), parent.getOid(), OrganisaatioTyyppi.TOIMIPISTE.value());
    ...
    public void assert_saveLisatietokenttaArvo_validate(List<YhteystietoElementtiDTO> kentat, List arvot, String expectedError) throws GenericFault {
        ...
        YhteystietojenTyyppiDTO lisatiedot = createYTT("test lisatiedot");
        lisatiedot.getSovellettavatOrganisaatios().add(OrganisaatioTyyppi.TOIMIPISTE);
