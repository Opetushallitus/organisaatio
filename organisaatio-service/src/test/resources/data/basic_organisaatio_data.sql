...
INSERT INTO ORGANISAATIOMETADATA(ID, VERSION, LUONTIPVM, MUOKKAUSPVM) VALUES (1, 1, DATE '1970-01-01', DATE '1970-01-01');

INSERT INTO YHTEYSTIETO(DTYPE, ID, VERSION, YHTEYSTIETOOID, OSOITE, OSOITETYYPPI, POSTINUMERO, POSTITOIMIPAIKKA, KIELI)
VALUES ('Osoite', 1000, 1, '1.2.2004.4', 'Hassuttimenkatu 2', 'kaynti', '10000', 'Äyhtävä', 'kieli_fi#1');

INSERT INTO ORGANISAATIOMETADATA_YHTEYSTIETO(ORGANISAATIOMETADATA_ID, YHTEYSTIEDOT_ID) VALUES(1,1000);
...
(4, 2, NULL, NULL, 'Helsinki', NULL, NULL, 'node2 foo', '1.2.2004.3', NULL, NULL, 'oppilaitostyyppi_42#1', FALSE, NULL, NULL, NULL, '|1|2|', '|1.2.246.562.24.00000000001|1.2.2004.1|', NULL, NULL, NULL, NULL, 'oy', NULL, '1234567-3', NULL, NULL, 4),
(5, 2, NULL, NULL, 'Helsinki', NULL, NULL, 'node22 foo bar', '1.2.2004.4', NULL, NULL, 'oppilaitostyyppi_42#1', FALSE, NULL, NULL, NULL, '|1|2|4|', '|1.2.246.562.24.00000000001|1.2.2004.1|1.2.2004.3|', NULL, NULL, NULL, NULL, 'oy', NULL, '1234567-4', NULL, 1, 5),
