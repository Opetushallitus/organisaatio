...
INSERT INTO monikielinen_teksti(ID, VERSION) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
INSERT INTO monikielinen_teksti_values(ID, VALUE, KEY) VALUES
(1, 'opetushallitus', 'fi'),
...
INSERT INTO ORGANISAATIO_META_DATA(ID, VERSION, LUONTIPVM, MUOKKAUSPVM, HAKUTOIMISTO_NIMI_ID) VALUES
(1, 1, DATE '1970-01-01', DATE '1970-01-01', 1000),
(2, 1, DATE '1970-01-01', DATE '1970-01-01', 1000);

INSERT INTO YHTEYSTIETO(DTYPE, ID, VERSION, YHTEYSTIETO_OID, OSOITE, OSOITE_TYYPPI, POSTINUMERO, POSTITOIMIPAIKKA, KIELI) VALUES
...
INSERT INTO YHTEYSTIETO(DTYPE, ID, VERSION, YHTEYSTIETO_OID, WWW_OSOITE, KIELI) VALUES
('Www', 1101, 1, '1.2.2004.100', 'http://www.foo.fi', 'kieli_fi#1'),
('Www', 1102, 1, '1.2.2004.101', 'http://www.foo.fi/en', 'kieli_en#1');

INSERT INTO YHTEYSTIETO(DTYPE, ID, VERSION, YHTEYSTIETO_OID, PUHELINNUMERO, TYYPPI, KIELI) VALUES
('Puhelinnumero', 1201, 1, '1.2.2004.201', '123456789', 'puhelin', 'kieli_fi#1');

INSERT INTO YHTEYSTIETO(DTYPE, ID, VERSION, YHTEYSTIETO_OID, EMAIL, KIELI) VALUES
('Email', 1301, 1, '1.2.2004.301', 'foo@bar.com', 'kieli_fi#1');

INSERT INTO ORGANISAATIO_META_DATA_YHTEYSTIEDOT(ORGANISAATIO_META_DATA_ID, YHTEYSTIEDOT_ID) VALUES
(1, 1000),
(1, 1001),
(1, 1002),
(1, 1003),
...
INSERT INTO ORGANISAATIO(ID, VERSION, ALKUPVM, DOMAINNIMI, KOTIPAIKKA, LAKKAUTUSPVM, MAA, NIMIHAKU, OID, OPETUSPISTEENJARJNRO, OPPILAITOSKOODI, OPPILAITOS_TYYPPI, ORGANISAATIO_POISTETTU, PAIVITTAJA, PAIVITYSPVM, PARENTIDPATH, PARENTOIDPATH, TOIMIPISTEKOODI, TUONTIPVM, VIRASTOTUNNUS, YHTEISHAUNKOULUKOODI, YRITYSMUOTO, YTJPAIVITYSPVM, YTUNNUS, KUVAUS_MKT, METADATA_ID, NIMI_MKT) VALUES
(1, 0, DATE '2004-06-29', NULL, 'Helsinki', NULL, NULL, 'opetushallitus', '1.2.246.562.24.00000000001', NULL, NULL, NULL, FALSE, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'oy', NULL, NULL, NULL, NULL, 1),
(2, 2, DATE '2004-08-08', NULL, 'Helsinki', NULL, NULL, 'root test koulutustoimija', '1.2.2004.1', NULL, '12345', NULL, FALSE, NULL, NULL, '|1|', '|1.2.246.562.24.00000000001|', NULL, NULL, NULL, NULL, 'oy', NULL, '2255802-1', NULL, NULL, 2),
(3, 2, DATE '2013-06-29', NULL, 'Helsinki', NULL, NULL, 'node1 asd', '1.2.2004.2', 1, NULL, 'oppilaitostyyppi_41#1', FALSE, NULL, NULL, '|1|2|', '|1.2.246.562.24.00000000001|1.2.2004.1|', '123451', NULL, NULL, NULL, 'oy', NULL, '1234567-2', NULL, NULL, 3),
(4, 2, NULL, NULL, 'Helsinki', NULL, NULL, 'node2 foo', '1.2.2004.3', 2, NULL, 'oppilaitostyyppi_42#1', FALSE, NULL, NULL, '|1|2|', '|1.2.246.562.24.00000000001|1.2.2004.1|', '123452', NULL, NULL, NULL, 'oy', NULL, '1234567-3', NULL, 1, 4),
(5, 2, NULL, NULL, 'Helsinki', NULL, NULL, 'node22 foo bar', '1.2.2004.4', NULL, NULL, 'oppilaitostyyppi_42#1', FALSE, NULL, NULL, '|1|2|4|', '|1.2.246.562.24.00000000001|1.2.2004.1|1.2.2004.3|', NULL, NULL, NULL, NULL, 'oy', NULL, '1234567-4', NULL, NULL, 5),
(6, 2, DATE '2010-08-29', NULL, 'Helsinki', NULL, NULL, 'node23 foo bar', '1.2.2005.4', NULL, NULL, 'oppilaitostyyppi_42#1', FALSE, NULL, NULL, '|1|2|4|', '|1.2.246.562.24.00000000001|1.2.2004.1|1.2.2004.3|', NULL, NULL, NULL, NULL, 'oy', NULL, '1234568-4', NULL, NULL, 6),
(7, 2, DATE '2006-06-29', NULL, 'Helsinki', NULL, NULL, 'root2 test2 koulutustoimija2', '1.2.2004.5', NULL, NULL, NULL, FALSE, NULL, NULL, '|1|', '|1.2.246.562.24.00000000001|', NULL, NULL, NULL, NULL, 'oy', NULL, '1492449-0', NULL, NULL, 7),
(8, 1, DATE '2008-04-11', NULL, 'Helsinki', DATE '2011-06-29', NULL, 'nodex bar', '1.2.2004.6', NULL, NULL, 'oppilaitostyyppi_41#1', FALSE, NULL, NULL, '|1|7|', '|1.2.246.562.24.00000000001|1.2.2004.5|', NULL, NULL, NULL, NULL, 'oy', NULL, '1234567-6', NULL, NULL, 8),
(9, 2, DATE '1960-02-16', NULL, 'Helsinki', NULL, NULL, 'node231 foo bar', '1.2.2005.5', NULL, NULL, 'oppilaitostyyppi_42#1', FALSE, NULL, NULL, '|1|2|4|5|', '|1.2.246.562.24.00000000001|1.2.2004.1|1.2.2004.3|1.2.2004.4|', NULL, NULL, NULL, NULL, 'oy', NULL, '1730639-9', NULL, NULL, 9),
(10, 2, NULL, NULL, 'Helsinki', NULL, NULL, 'mixed osoitetyyppi organisaatio', '1.2.8000.1', NULL, NULL, 'oppilaitostyyppi_42#1', FALSE, NULL, NULL, '|1|', '|1.2.246.562.24.00000000001|', NULL, NULL, NULL, NULL, 'oy', NULL, '1234569-5', NULL, 2, 6);

INSERT INTO YHTEYSTIETO(DTYPE, ID, VERSION, KIELI, YHTEYSTIETO_OID, COORDINATETYPE, EXTRARIVI, LAT, LNG, MAA, OSAVALTIO, OSOITE, OSOITE_TYYPPI, POSTINUMERO, POSTITOIMIPAIKKA, YTJPAIVITYSPVM, PUHELINNUMERO, TYYPPI, EMAIL, WWW_OSOITE, ORGANISAATIO_ID) VALUES
