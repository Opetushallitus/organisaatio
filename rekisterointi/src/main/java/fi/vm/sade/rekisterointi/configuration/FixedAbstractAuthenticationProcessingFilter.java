/*
 * This class is copy-pasted from Spring 6.1.0 due to an issue in CasAuthenticationFilter and
 * can be removed when the issue below has been resolved
 *
 ...
 * @author Luke Taylor
 */
public abstract class FixedAbstractAuthenticationProcessingFilter extends GenericFilterBean
	 ...
	 */
	protected FixedAbstractAuthenticationProcessingFilter(String defaultFilterProcessesUrl) {
	 ...
	 */
	protected FixedAbstractAuthenticationProcessingFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
