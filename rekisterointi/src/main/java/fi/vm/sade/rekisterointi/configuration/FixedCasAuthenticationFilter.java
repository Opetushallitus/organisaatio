...
import org.springframework.util.Assert;
  ...
  * @author Rob Winch
  */
 public class FixedCasAuthenticationFilter extends FixedAbstractAuthenticationProcessingFilter {
     ...
     public FixedCasAuthenticationFilter() {
         super("/login/cas");
     ...
     private class CasAuthenticationFailureHandler implements AuthenticationFailureHandler {
         ...
         public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
             ...
             if (serviceTicketRequest(request, response)) {
                 ...
                 FixedCasAuthenticationFilter.this.proxyFailureHandler.onAuthenticationFailure(request, response, exception);
             }
         }
