        ...
        <nav className={styles.nav}>
            <div>
                <div className={stepClasses(ORGANISAATION_TIEDOT)}>
                    ...
                    <div {...(props.currentStep === ORGANISAATION_TIEDOT ? {'aria-current': 'step'} : {} )}>{i18n.translate('ORGANISAATION_TIEDOT')}</div>
                </div>
                <div className={lineClasses(1.5)}></div>
                <div className={stepClasses(2)}>
                    <div className={styles.circle}>2</div>
                    <div {...(props.currentStep === KAYTTAJAN_YHTEYSTIEDOT ? {'aria-current': 'step'} : {} )}>{i18n.translate('KAYTTAJAN_YHTEYSTIEDOT')}</div>
                </div>
                <div className={lineClasses(2.5)}></div>
                <div className={stepClasses(3)}>
                    <div className={styles.circle}>3</div>
                    <div {...(props.currentStep === YHTEENVETO ? {'aria-current': 'step'} : {} )}>{i18n.translate('YHTEENVETO')}</div>
                </div>
